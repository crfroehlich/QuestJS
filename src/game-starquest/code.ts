...
const roster = {
  ...
  hasOfficer: function (pos: any) { return Quest.World.w.ship[pos] !== undefined },
  // get the officer object assigned to the role or null if not set
  // @ts-expect-error ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
  getOfficer: function (pos: any) { return this.hasOfficer(pos) ? Quest.World.w[Quest.World.w.ship[pos]] : null },
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'addDirective' does not exist on type '{ ... Remove this comment to see the full error message
Quest.Text.addDirective("sir", function (arr: any, params: any) { return Quest.World.player.callmemaam ? "ma'am" : "sir" })
// @ts-expect-error ts-migrate(2339) FIXME: Property 'addDirective' does not exist on type '{ ... Remove this comment to see the full error message
Quest.Text.addDirective("Sir", function (arr: any, params: any) { return Quest.World.player.callmemaam ? "Ma'am" : "Sir" })
...
Quest.Text.addDirective("time", function (arr: any, params: any) {
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'ship' does not exist on type '{}'.
  return "Stardate " + Quest.World.w.ship.getDateTime(arr[0])
})
...
const newCmds = [
  {
    name: 'Intro1',
    script: function () { Quest.IO.showDiag('Welcome to your new ship, captain!', '<br/>' + this.text.replace(/\|/g, '<br/><br/>'), 'Okay'); return Quest.World.world.SUCCESS },
  ...
  {
    name: 'Intro2',
    script: function () { Quest.IO.showDiag('Getting started', '<br/>' + this.text.replace(/\|/g, '<br/><br/>'), 'Okay'); return Quest.World.world.SUCCESS },
  ...
  {
    name: 'Intro3',
    script: function () { Quest.IO.showDiag('Additional notes', '<br/>' + this.text.replace(/\|/g, '<br/><br/>'), 'Okay'); return Quest.World.world.SUCCESS },
