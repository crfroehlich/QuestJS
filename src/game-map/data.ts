...
Quest.World.createRoom("lounge", {
  ...
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  south: new Quest.World.Exit('hall'),
  mapColour: 'red',
  mapWidth: 45,
  mapHeight: 45,
})
...
Quest.World.createRoom("kitchen", {
  desc: "The lounge is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('garden_east'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  north: new Quest.World.Exit('dining_room'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  east: new Quest.World.Exit('hall'),
})
...
Quest.World.createRoom("dining_room", {
  ...
  west: new Quest.World.Exit('garden_east', {
    mapOffsetY: -1, mapDrawBase: function (fromRoom: any, toRoom: any) {
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("hall", {
  desc: "The hall is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  up: new Quest.World.Exit('landing'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('kitchen'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  north: new Quest.World.Exit('lounge'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  east: new Quest.World.Exit('street_middle'),
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  south: new Quest.World.Exit('conservatory', { mapOffsetX: -0.5 }),
  mapWidth: 25,
})
...
Quest.World.createRoom("conservatory", {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  north: new Quest.World.Exit('hall', { mapOffsetX: 0.5 }),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('shed'),
  mapColour: '#88f',
})
...
Quest.World.createRoom("shed", {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  north: new Quest.World.Exit('garden_east', { mapOffsetX: -0.5 }),
})
...
Quest.World.createItem("Lara", Quest.NPC.NPC(true), {
  ...
  mapDrawBase: function () { return map.rectangle(Quest.World.w[this.loc], [[-5, -5], [10, 10]], 'fill:red;stroke:black') }
})
...
Quest.World.createItem("Kyle", Quest.NPC.NPC(false), {
  ...
  agenda: ['walkRandom'],
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'rectangle' does not exist on type '{ tog... Remove this comment to see the full error message
  mapDrawBase: function () { return map.rectangle(Quest.World.w[this.loc], [[0, 0], [10, 10]], 'fill:blue;stroke:black') }
})
...
Quest.World.createItem("Robot", Quest.NPC.NPC(false), {
  ...
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'rectangle' does not exist on type '{ tog... Remove this comment to see the full error message
  mapDrawBase: function () { return map.rectangle(Quest.World.w[this.loc], [[-10, -10], [10, 10]], 'fill:silver;stroke:black') }
})


// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("garden_east", {
  desc: "The east end of the garden is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  east: new Quest.World.Exit('kitchen'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('garden_west'),
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  south: new Quest.World.Exit('shed', { mapOffsetX: 0.5 }),
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("garden_west", {
  desc: "The west end of the garden is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  east: new Quest.World.Exit('garden_east'),
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  south: new Quest.World.Exit('fairy_grotto', {
    mapOffsetY: -2, mapDrawBase: function (fromRoom: any, toRoom: any) {
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'bezier' does not exist on type '{ toggle... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("fairy_grotto", {
  desc: "The fairy grotto is amazing! But the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  north: new Quest.World.Exit('garden_west', { mapIgnore: true }),
  mapDrawBase: function () {
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("landing", {
  desc: "The lounge is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  down: new Quest.World.Exit('hall'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('bedroom'),
})
...
Quest.World.createRoom("bedroom", {
  ...
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  east: new Quest.World.Exit('landing'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  in: new Quest.World.Exit('glade'),
})



// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("street_middle", {
  desc: "The lounge is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  west: new Quest.World.Exit('hall'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  north: new Quest.World.Exit('street_north'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  south: new Quest.World.Exit('street_south'),
  mapDrawBase: function () {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'rectRoom' does not exist on type '{ togg... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("street_north", {
  desc: "The street_north is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  south: new Quest.World.Exit('street_middle'),
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  north: new Quest.World.Exit('bus'),
  mapDrawBase: function () { return '' },
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'street_middle' does not exist on type '{... Remove this comment to see the full error message
  afterFirstEnter: function () { Quest.World.w.street_middle.visited++ },
})

// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 2.
Quest.World.createRoom("street_south", {
  desc: "The street_south is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  north: new Quest.World.Exit('street_middle'),
  mapDrawBase: function () { return '' },
})
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 3.
Quest.World.createRoom("bus", Quest.Templates.TRANSIT("south"), {
  desc: "The bus is boring, the author really needs to put stuff in it.",
  // @ts-expect-error ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
  south: new Quest.World.Exit('street_north'),
  mapColour: 'red',
  ...
  mapDrawBase: function (level: any, el: any) {
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 3.
Quest.World.createItem("button_street", Quest.Templates.TRANSIT_BUTTON("bus"), {
  alias: "Button: Street",
...
// @ts-expect-error ts-migrate(2554) FIXME: Expected 0 arguments, but got 3.
Quest.World.createItem("button_glade", Quest.Templates.TRANSIT_BUTTON("bus"), {
  alias: "Button: Glade",
