...
Quest.Settings.settings.mapStyle = { right: '0', top: '200px', width: '400px', height: '400px', 'background-color': '#ddd', border: '3px black solid', 'background-image': 'url(game-map/paper.jpg)' }
