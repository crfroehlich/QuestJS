  ...
  export namespace RPG {
    ...
    export class Attack {
      ...
      static createAttack(attacker: any, target: any, skill: any, source: any) {
        const attack = new Quest.RPG.Attack();
      ...
      resolve(target: any, isPrimary: any, count = 0) {
        ...
        this.msg(Quest.Text.processText('---\nTargeting {nm:target:the}...', { attacker: this.attacker, skill: this.skill, target }), 3);
      ...
      msg(s: any, n: any) {
        this.reportTexts.push({ level: n || 1, t: Quest.Text.processText(s, this) });
      }
