namespace Quest {
  export namespace Skill {
    export class Skill {
      ...
      testUseable(char: any) { return Quest.RPG.rpg.defaultSkillTestUseable(char) }
      afterUse(attack: any, count: any) { Quest.RPG.rpg.defaultSkillAfterUse(attack, count) }
    }
    ...
    export class Spell extends Skill {
      ...
      testUseable(char: any) { return Quest.RPG.rpg.defaultSpellTestUseable(char) }
      afterUse(attack: any, count: any) { Quest.RPG.rpg.defaultSpellAfterUse(attack, count) }
    }
