...
new SpellInanimate("Earthmight Smasher", {
  ...
  getTargets:function(attack: any) { return scopeReachable().filter(el => el.weaponType === 'crush' && el.loc === attack.attacker.name) },
...
new SpellInanimate("Storm Bow", {
  ...
  getTargets:function(attack: any) { return scopeReachable().filter(el => el.weaponType === 'bow' && el.loc === attack.attacker.name) },
  targetEffect:function(attack: any, item: any) {
...
new SpellInanimate("Ice Spear", {
  ...
  getTargets:function(attack: any) { return scopeReachable().filter(el => el.weaponType === 'polearm' && el.loc === attack.attacker.name) },
  targetEffect:function(attack: any, item: any) {
...
new SpellInanimate("Flaming Blade", {
  ...
  getTargets:function(attack: any) { return scopeReachable().filter(el => el.weaponType === 'blade' && el.loc === attack.attacker.name) },
  targetEffect:function(attack: any, item: any) {
