namespace Quest {
  export namespace Text {
    ...
    export const getSaveString = function () {
      ...
      let s = "TPUsedStrings=" + Quest.SaveLoad.saveLoad.encodeArray(usedStrings);
      return s;
    };
    ...
    const i = function (arr: any, params: any) { return "<i>" + arr.join(":") + "</i>"; };
    const b = function (arr: any, params: any) { return "<b>" + arr.join(":") + "</b>"; };
    const u = function (arr: any, params: any) { return "<u>" + arr.join(":") + "</u>"; };
    const s = function (arr: any, params: any) { return "<strike>" + arr.join(":") + "</strike>"; };
    const code = function (arr: any, params: any) { return "<code>" + arr.join(":") + "</code>"; };
    const sup = function (arr: any, params: any) { return "<sup>" + arr.join(":") + "</sup>"; };
    const sub = function (arr: any, params: any) { return "<sub>" + arr.join(":") + "</sub>"; };
    const huge = function (arr: any, params: any) { return '<span style="font-size:2em">' + arr.join(":") + '</span>'; };
    const big = function (arr: any, params: any) { return '<span style="font-size:1.5em">' + arr.join(":") + '</span>'; };
    const small = function (arr: any, params: any) { return '<span style="font-size:0.8em">' + arr.join(":") + '</span>'; };
    const tiny = function (arr: any, params: any) { return '<span style="font-size:0.6em">' + arr.join(":") + '</span>'; };
    const smallcaps = function (arr: any, params: any) { return '<span style="font-variant:small-caps">' + arr.join(":") + '</span>'; };
    ...
    const selectNone = function (arr: any, params: any) { return select(arr, params, 'none') }
    const selectWrap = function (arr: any, params: any) { return select(arr, params, 'wrap') }
    const selectStart = function (arr: any, params: any) { return select(arr, params, 'start') }
    const selectEnd = function (arr: any, params: any) { return select(arr, params, 'end') }
    ...
    const notOnce = function (arr: any, params: any) { return once(params, arr[1], arr[0]) }
    ...
    //-----------  CONDITIONALS  --------------------
    const iif = function (arr: any, params: any) { return handleIf(arr, params, false) }
    const ifNot = function (arr: any, params: any) { return handleIf(arr, params, true) }
    ...
    const ifIs = function (arr: any, params: any) { return handleIfIs(arr, params, false) }
    const ifNotIs = function (arr: any, params: any) { return handleIfIs(arr, params, true) }
    ...
    const ifExists = function (arr: any, params: any) { return handleIfExists(arr, params, false) }
    const ifNotExists = function (arr: any, params: any) { return handleIfExists(arr, params, true) }
    ...
    const ifLessThan = function (arr: any, params: any) { return handleIfLessMoreThan(arr, params, false, false) }
    const ifMoreThan = function (arr: any, params: any) { return handleIfLessMoreThan(arr, params, true, false) }
    const ifLessThanOrEqual = function (arr: any, params: any) { return handleIfLessMoreThan(arr, params, false, true) }
    const ifMoreThanOrEqual = function (arr: any, params: any) { return handleIfLessMoreThan(arr, params, true, true) }
    ...
    const ifHere = function (arr: any, params: any) { return handleIfHere(arr, params, false, 'loc') }
    const ifNotHere = function (arr: any, params: any) { return handleIfHere(arr, params, true, 'loc') }
    const ifHeld = function (arr: any, params: any) { return handleIfHere(arr, params, false, 'name') }
    const ifNotHeld = function (arr: any, params: any) { return handleIfHere(arr, params, true, 'name') }
    ...
    const ifPlayer = function (arr: any, params: any) { return handleIfPlayer(arr, params, false) }
    const ifNotPlayer = function (arr: any, params: any) { return handleIfPlayer(arr, params, true) }
    ...
    */
    ...
    const nm = function (arr: any, params: any) { return nameFunction(arr, params, false) }
    const nms = function (arr: any, params: any) { return nameFunction(arr, params, true) }
    ...
    const nv = function (arr: any, params: any) { return conjugations(Quest.lang.nounVerb, arr, params) }
    const pv = function (arr: any, params: any) { return conjugations(Quest.lang.pronounVerb, arr, params) }
    const vn = function (arr: any, params: any) { return conjugations(Quest.lang.verbNoun, arr, params) }
    const vp = function (arr: any, params: any) { return conjugations(Quest.lang.verbPronoun, arr, params) }
    const cj = function (arr: any, params: any) { return conjugations(Quest.lang.conjugate, arr, params) }
    ...
    export const text_processors = {
      ...
      cmd,
      img,
      once: function (arr: any, params: any) { return once(params, arr[0], arr[1]) },
      first: function (arr: any, params: any) { return once(params, arr[0], arr[1]) },
      contents,
      dateTime,
      rndalt,
      money,
      ...
      blur,
      transitDest,
      select: function (arr: any, params: any) { return select(arr, params, 'none') }
    }
  }
}