...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'setup' does not exist on type '{}'.
...
board.update = function() {
  ...
  for (let i = 0; i < this.settings.size; i++) {
    for (let j = 0; j < i; j++) {
      ...
      // @ts-expect-error ts-migrate(2339) FIXME: Property 'handleCell' does not exist on type '{}'.
...
board.handleCell = function(x: any, y: any) {
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'getCoord' does not exist on type '{}'.
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'getTitle' does not exist on type '{}'.
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'getCompass' does not exist on type '{}'.
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'getSwitches' does not exist on type '{}'... Remove this comment to see the full error message
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'getBase' does not exist on type '{}'.
...
// @ts-expect-error ts-migrate(2339) FIXME: Property 'toggle' does not exist on type '{}'.
