...
namespace Quest {
  export namespace FileSaver {
    ...
    var isMacOSWebView = globalThis.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent)
        ...
        : ('download' in HTMLAnchorElement.prototype && !isMacOSWebView)
          ...
          : 'msSaveOrOpenBlob' in navigator
            ...
            : function saveAs(blob: any, name: any, opts: any, popup: any) {
              ...
              var isSafari = /constructor/i.test(globalThis.HTMLElement) || globalThis.safari
