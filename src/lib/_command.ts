...
export function NpcCmd(this: any, name: any, hash: any) {
...
export function ExitCmd(this: any, name: any, dir: any, hash: any) {
  const cmd = new Cmd(name, hash);
  Object.assign(this, cmd);
  // Cmd.call(this, name, hash);
  this.exitCmd = true;
...
export function NpcExitCmd(this: any, name: any, dir: any, hash: any) {
  const cmd = new Cmd(name, hash);
  Object.assign(this, cmd);
  // Cmd.call(this, name, hash);
  this.exitCmd = true;
...
export function extractChar(cmd: any, objects: any) {
  let char;
  if (cmd.forNpc) {
    char = objects[0][0];
    if (!char.npc) {
...
export function testCmd(name: any, s: any) {
