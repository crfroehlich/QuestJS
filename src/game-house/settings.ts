...
Quest.settings.title = "The House on Highfield Lane"
...
Quest.settings.author = "Andy Joel"
...
Quest.settings.ifid = "8F79966F-54C6-4DA3-842A-330DBA5D0CB0"
...
Quest.settings.additionalAbout = {
...
Quest.settings.warnings = "Occasional bad language, including the F-word. A couple of locations have seen recent battles, and there are a lot bodies, but no graphic descriptions."
...
Quest.settings.transcript = 'walk'
...
Quest.settings.convertDoubleDash = true


Quest.settings.files = [
...
Quest.settings.getDefaultRoomHeading = function(item) { return titleCase(lang.addDefiniteArticle(item) + item.alias) }
Quest.settings.symbolsForCompass = true
//Quest.settings.panes = 'none'
// @ts-expect-error ts-migrate(2339) FIXME: Property 'playMode' does not exist on type '{ perf... Remove this comment to see the full error message
Quest.settings.panes = Quest.settings.playMode === "dev" ? 'left' : 'none'
Quest.settings.themes = ['serif']
...
Quest.settings.favicon = 'assets/icons/houseicon.png'
...
Quest.settings.fluids = ['sand', 'water']
Quest.settings.saveLoadExcludedAtts.push('silverSighting')
...
Quest.settings.customNoExitMsg = function(char: any, dir: any) {
...
Quest.settings.finishMetaComment = "Congratulations on completing \"The House on Highfield Lane\". You can read about some of the background to the game and how I created it {link:here:" + folder + "/story.html}."
