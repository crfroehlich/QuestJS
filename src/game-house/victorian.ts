...
createRoom("front_hall", {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  north:new Exit("brass_dining_room", {use:function(char: any) {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  south:new Exit("gallery", {use:function(char: any) {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'front_hall' does not exist on type '{}'.
...
createRoom("gallery", ROOM_SET("gallery"), {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  east:new Exit("_", {simpleUse:function(char: any) {
...
createRoom("room_big", {
  ...
  // @ts-expect-error ts-migrate(7009) FIXME: 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
  west:new Exit("_", {simpleUse:function(char: any) {
    // @ts-expect-error ts-migrate(2339) FIXME: Property 'room_big' does not exist on type '{}'.
