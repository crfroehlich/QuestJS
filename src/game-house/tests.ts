...
test.tests = function () {
  ...
  test.assertEqual("Mandy watches as four shoots grow.", Quest.Text.processText("Mandy watches as {nv:item:grow:false:grown_tamarind_tree_count}.", { item: Quest.World.w.grown_tamarind_tree, grown_tamarind_tree_count: 4 }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy can see four shoots.", Quest.Text.processText("Mandy can see {nm:item:count}.", { item: Quest.World.w.grown_tamarind_tree, grown_tamarind_tree_count: 4 }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy watches as three shoots grow; the shoots are now about two centimetres high.", Quest.Text.processText("Mandy watches as {nv:item:grow:false:count_this}; {nv:item:be:false:count_this:suppressCount} now about {show:grown_tamarind_tree:getHeight} high.", { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted', suppressCount: 'seedsPlanted' }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy can see three shoots.", Quest.Text.processText("Mandy can see {nm:item:count:false:count_this}.", { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted' }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy watches as three shoots grow; the shoots are now about two centimetres high.", Quest.Text.processText("Mandy watches as {nv:item:grow:false:count_this}; {nv:item:be:false:count_this:suppressCount} now about {show:grown_tamarind_tree:getHeight} high.", { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted', suppressCount: 'seedsPlanted' }))
  ...
  Quest.World.w.grown_tamarind_tree.update()
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy watches as the plant grows.", Quest.Text.processText("Mandy watches as {nv:item:grow:false:grown_tamarind_tree_count}.", { item: Quest.World.w.grown_tamarind_tree, grown_tamarind_tree_count: 1 }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy can see one plant.", Quest.Text.processText("Mandy can see {nm:item:count}.", { item: Quest.World.w.grown_tamarind_tree, grown_tamarind_tree_count: 1 }))
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  test.assertEqual("Mandy watches as the plant grows; the plant is now about twenty centimetres high.", Quest.Text.processText("Mandy watches as {nv:item:grow:false:count_this}; {nv:item:be} now about {show:grown_tamarind_tree:getHeight} high.", { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted' }))
  ...
  Quest.World.w.grown_tamarind_tree.update()
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'grown_tamarind_tree' does not exist on t... Remove this comment to see the full error message
  s_out = Quest.Text.processText(s_in, { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted', suppressCount: 'seedsPlanted' })
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
  ...
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'grown_tamarind_tree' does not exist on t... Remove this comment to see the full error message
  s_out = Quest.Text.processText("{nv:item:wither:true:suppressCount} away to nothing.", { item: Quest.World.w.grown_tamarind_tree, count_this: 'seedsPlanted', suppressCount: 'seedsPlanted' })
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
