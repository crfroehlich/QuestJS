...
import { msg, wait, falsemsg }        from '../../lib/io';
    ...
    askOptions: [
      {
        script(p: any) {
          ...
          // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 1.
          msg(Quest.World.w.house_man.talkCount === 4 ? "'Yeah, okay, I get it,' mutters Mandy. 'You must be a whole barrel of laughs at a party.'" : 'Mandy wonders what she should say.');
