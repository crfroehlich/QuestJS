  ...
  const newCmds = [
    {
      name: 'Intro1',
      script() {
        Quest.IO.showDiag('Welcome to your new ship, captain!', `<br/>${this.text.replace(/\|/g, '<br/><br/>')}`, 'Okay'); return Quest.World.world.SUCCESS;
      },
    ...
    },
    {
      name: 'Intro2',
      script() {
        Quest.IO.showDiag('Getting started', `<br/>${this.text.replace(/\|/g, '<br/><br/>')}`, 'Okay'); return Quest.World.world.SUCCESS;
      },
    ...
    },
    {
      name: 'Intro3',
      script() {
        Quest.IO.showDiag('Additional notes', `<br/>${this.text.replace(/\|/g, '<br/><br/>')}`, 'Okay'); return Quest.World.world.SUCCESS;
      },
