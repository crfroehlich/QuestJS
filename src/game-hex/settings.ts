...
Quest.settings.libraries.push('hex-map')
...
Quest.settings.mapDefaultAlias = function(o: any) {
...
Quest.settings.mapClick = function(x: any, y: any) {
  log(x + ',' + y)
}
...
Quest.settings.mapLabelOffset = -8
...
Quest.settings.mapLabelRotate = -10
...
Quest.settings.mapHexStroke = '#fff'
...
Quest.settings.mapHexStrokeWidth = 4
...
Quest.settings.mapDefaultColour = 'deepskyblue'
...
Quest.settings.mapRiverColour = 'dodgerblue'
...
Quest.settings.mapReportRepeats = true
