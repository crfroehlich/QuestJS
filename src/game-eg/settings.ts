...
Quest.Settings.settings.mapStyle = { right: '0', top: '200px', width: '300px', height: '300px', 'background-color': 'yellow' }
...
Quest.Settings.settings.mapLabelStyle = { 'font-size': '8pt', 'font-weight': 'bold', color: 'blue' }
