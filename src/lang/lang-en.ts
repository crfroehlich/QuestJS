...
const lang = {
  ...
  object_unknown_msg: function (name: any) {
  ...
  speak_to_menu_title: function (char: any) {
  ...
  npc_leaving_msg: function (npc: any, exit: any) {
  ...
  addArticle: function (item: any, type: any) {
  ...
  getName: function (item: any, options: any) {
    if (!options) options = {}
  ...
  conjugate: function (item: any, verb: any, options = {}) {
  ...
  pronounVerb: function (item: any, verb: any, options: any) {
  ...
  pronounVerbForGroup: function (item: any, verb: any, options: any) {
    let s = item.groupPronouns().subjective + " " + lang.conjugate(item.group(), verb);
    s = s.replace(/ +\'/, "'");  // yes this is a hack!
    return options.capitalise ? Quest.Utilities.sentenceCase(s) : s;
  },

  verbPronoun: function (item: any, verb: any, options: any) {
...
lang.createVerb = function (name: any, options = {}) {
...
lang.createVerbWith = function (name: any, options = {}) {
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'words' does not exist on type '{}'.
  if (options.words === undefined) options.words = name.toLowerCase()
  // @ts-expect-error ts-migrate(2339) FIXME: Property 'ing' does not exist on type '{}'.
  if (options.ing === undefined) options.ing = name + 'ing'
