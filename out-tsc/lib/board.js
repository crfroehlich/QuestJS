...
board.update = function () {
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.defs)
        this.map.push(this.settings.defs());
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'map' does not exist on type '{}'.
    this.map.push('</defs>');
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.title)
        this.map.push(board.getTitle());
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.baseHeight)
        this.map.push(board.getBase());
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.compassPane)
        this.map.push(board.getCompass(this.settings.compass.x, this.settings.compass.y));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.switches)
        this.map.push(board.getSwitches());
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
    if (this.settings.extras)
        this.map.push(this.settings.extras());
    // ts-error-fixed ts-migrate(2531) FIXME: Object is possibly 'null'.
...
board.getTitle = function () {
    ...
    if (this.settings.titleStyle)
        s += `" style="${this.settings.titleStyle}`;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'settings' does not exist on type '{}'.
