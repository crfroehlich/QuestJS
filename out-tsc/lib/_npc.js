...
export const NPC = function (isFemale) {
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'npc' does not exist on type '{ canReachT... Remove this comment to see the full error message
    res.npc = true;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'isFemale' does not exist on type '{ canR... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'askOptions' does not exist on type '{ ca... Remove this comment to see the full error message
    res.askOptions = [];
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'tellOptions' does not exist on type '{ c... Remove this comment to see the full error message
    res.tellOptions = [];
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'excludeFromAll' does not exist on type '... Remove this comment to see the full error message
    res.excludeFromAll = true;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactions' does not exist on type '{ can... Remove this comment to see the full error message
    res.reactions = [];
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'icon' does not exist on type '{ canReach... Remove this comment to see the full error message
    res.icon = () => 'npc12';
    // This does not work properly, it just gets all clothing!!!
    // But authors could replace as required
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'getWearingVisible' does not exist on typ... Remove this comment to see the full error message
    res.getWearingVisible = function () {
        return this.getWearing();
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'isHere' does not exist on type '{ canRea... Remove this comment to see the full error message
    res.isHere = function () {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'isAtLoc' does not exist on type '{ canRe... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'multiMsg' does not exist on type '{ canR... Remove this comment to see the full error message
    res.multiMsg = function (ary) {
        ...
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (ary[this[counter]])
            Quest.IO.msg(ary[this[counter]]);
    };
    // can we see the NPC from here?
    // do we need a prefix?
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'inSight' does not exist on type '{ canRe... Remove this comment to see the full error message
    res.inSight = function (room) {
        ...
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (!room)
            room = Quest.World.w[this.loc];
        if (Quest.World.player.loc === room.name)
            return true;
        if (room.visibleFrom === undefined)
            return false;
        if (typeof room.visibleFrom === 'function')
            return room.visibleFrom(Quest.World.currentLocation);
        if (Array.isArray(room.visibleFrom)) {
            if (room.visibleFrom.includes(Quest.World.currentLocation.name))
                return room.visibleFromPrefix ? room.visibleFromPrefix : true;
        }
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'setLeader' does not exist on type '{ can... Remove this comment to see the full error message
    res.setLeader = function (npc) {
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (typeof npc === 'string')
            npc = Quest.World.w[npc];
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'leaderName' does not exist on type '{ ca... Remove this comment to see the full error message
        if (this.leaderName)
            Quest.Utilities.array.remove(Quest.World.w[this.leaderName].followers, this.name);
        if (npc) {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'name' does not exist on type '{ canReach... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'getFollowers' does not exist on type '{ ... Remove this comment to see the full error message
    res.getFollowers = function () {
        return this.followers.map((el) => Quest.World.w[el]);
    };
    // Used by commands
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'startFollow' does not exist on type '{ c... Remove this comment to see the full error message
    res.startFollow = function () {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'leaderName' does not exist on type '{ ca... Remove this comment to see the full error message
        if (this.leaderName)
            return Quest.IO.falsemsg(Quest.lang.already_following, { npc: this });
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'setLeader' does not exist on type '{ can... Remove this comment to see the full error message
        ...
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'endFollow' does not exist on type '{ can... Remove this comment to see the full error message
        res.endFollow = function () {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'leaderName' does not exist on type '{ ca... Remove this comment to see the full error message
            if (!this.leaderName)
                return Quest.IO.falsemsg(Quest.lang.already_waiting, { npc: this });
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'setLeader' does not exist on type '{ can... Remove this comment to see the full error message
            this.setLeader();
            // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 2.
            Quest.IO.msg('{nv:npc:nod:true} his head.', { npc: this });
    ...
    res.doReactions = function () {
        ...
        if (this.isHere() || Quest.Settings.settings.npcReactionsAlways) {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactionFlags' does not exist on type '{... Remove this comment to see the full error message
            if (!this.reactionFlags)
                this.reactionFlags = [];
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactions' does not exist on type '{ can... Remove this comment to see the full error message
            for (const el of this.reactions) {
                // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactionFlags' does not exist on type '{... Remove this comment to see the full error message
                if (this.reactionFlags.includes(el.name))
                    continue;
                if (el.test(this)) {
                    el.action(this);
                    // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactionFlags' does not exist on type '{... Remove this comment to see the full error message
                    ...
                    // ts-error-fixed ts-migrate(2339) FIXME: Property 'reactionFlags' does not exist on type '{... Remove this comment to see the full error message
                    if (el.override)
                        this.reactionFlags = this.reactionFlags.concat(el.override);
                }
            }
        }
    };
    ...
    // For ASK/TELL
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'topics' does not exist on type '{ canRea... Remove this comment to see the full error message
    res.topics = function () {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'askOptions' does not exist on type '{ ca... Remove this comment to see the full error message
        ...
        for (const action of ['ask', 'tell']) {
            ...
            for (const res of arr) {
                if (res.silent && !Quest.World.player.mentionedTopics.includes(res.name))
                    continue;
                arr2.push(res.name);
            }
            if (arr2.length !== 0) {
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayBonus' does not exist on type '{ canR... Remove this comment to see the full error message
    res.sayBonus = 0;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayPriority' does not exist on type '{ c... Remove this comment to see the full error message
    res.sayPriority = 0;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayState' does not exist on type '{ canR... Remove this comment to see the full error message
    res.sayState = 0;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayUsed' does not exist on type '{ canRe... Remove this comment to see the full error message
    res.sayUsed = ' ';
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayResponse' does not exist on type '{ c... Remove this comment to see the full error message
    res.sayResponse = function (s) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayResponses' does not exist on type '{ ... Remove this comment to see the full error message
        if (!this.sayResponses)
            return false;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayResponses' does not exist on type '{ ... Remove this comment to see the full error message
        for (const res of this.sayResponses) {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayUsed' does not exist on type '{ canRe... Remove this comment to see the full error message
            if (res.id && this.sayUsed.includes(` ${res.id} `))
                continue;
            if (!res.regex.test(s))
                continue;
            res.response();
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayCanHear' does not exist on type '{ ca... Remove this comment to see the full error message
    res.sayCanHear = function (char, verb) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'loc' does not exist on type '{ canReachT... Remove this comment to see the full error message
        return char.loc === this.loc;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'askQuestion' does not exist on type '{ c... Remove this comment to see the full error message
    res.askQuestion = function (questionName) {
        if (typeof questionName !== 'string')
            questionName = questionName.name;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayQuestion' does not exist on type '{ c... Remove this comment to see the full error message
        this.sayQuestion = questionName;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'sayQuestionCountdown' does not exist on ... Remove this comment to see the full error message
...
const npc_utilities = {
    askTopics(...topics) {
        ...
        fn(title, topics, (result) => {
            result.runscript();
        });
    },
    findTopic(alias, n = 1) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'findTopic' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(7023) FIXME: 'talkto' implicitly has return type 'any' because ... Remove this comment to see the full error message
    talkto() {
        // ts-error-fixed ts-migrate(2367) FIXME: This condition will always return 'true' since the... Remove this comment to see the full error message
        if (Quest.Settings.settings.noTalkTo !== false) {
            // ts-error-fixed ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
            Quest.IO.metamsg(Quest.Settings.settings.noTalkTo);
            return false;
        }
        if (!Quest.World.player.testTalk(this))
            return false;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'testTalk' does not exist on type '{ find... Remove this comment to see the full error message
        if (this.testTalk && !this.testTalk())
            return false;
        // handle non-dynamic talkto
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'talk' does not exist on type '{ findTopi... Remove this comment to see the full error message
        ...
        if (topics.length === 0)
            return Quest.IO.failedmsg(Quest.lang.no_topics, { char: Quest.World.player, item: this });
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'greeting' does not exist on type '{ find... Remove this comment to see the full error message
        if (this.greeting) {
        ...
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        const fn = Quest.IO.io.menuFunctions[Quest.Settings.settings.funcForDynamicConv];
        fn(Quest.lang.speak_to_menu_title(this), topics, (result) => {
...
export const AGENDA_FOLLOWER = function () {
    const res = {};
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'agenda' does not exist on type '{}'.
    res.agenda = [];
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'suspended' does not exist on type '{}'.
    res.suspended = false;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'followers' does not exist on type '{}'.
    res.followers = [];
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'inSight' does not exist on type '{}'.
    res.inSight = function () {
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'endTurn' does not exist on type '{}'.
    res.endTurn = function (turn) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'paused' does not exist on type '{}'.
        if (!this.paused && !this.suspended && this.agenda.length > 0)
            this.doAgenda();
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'doEvent' does not exist on type '{}'.
        this.doEvent(turn);
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'setAgenda' does not exist on type '{}'.
    res.setAgenda = function (agenda) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'agenda' does not exist on type '{}'.
        this.agenda = agenda;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'suspended' does not exist on type '{}'.
        this.suspended = false;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'agendaWaitCounter' does not exist on typ... Remove this comment to see the full error message
        this.agendaWaitCounter = false;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'patrolCounter' does not exist on type '{... Remove this comment to see the full error message
        this.patrolCounter = false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'doAgenda' does not exist on type '{}'.
    res.doAgenda = function () {
        // If this NPC has followers, we fake it so it seems to be the group
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'followers' does not exist on type '{}'.
        if (this.followers.length !== 0) {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'savedPronouns' does not exist on type '{... Remove this comment to see the full error message
            this.savedPronouns = this.pronouns;
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'savedAlias' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'pause' does not exist on type '{}'.
    res.pause = function () {
        // Quest.IO.debugmsg("pausing " + this.name);
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'leaderName' does not exist on type '{}'.
        if (this.leaderName) {
            // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
...
export const agenda = {
    debug(s, npc, arr) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'agendaDebugging' does not exist on type ... Remove this comment to see the full error message
        if (Quest.Settings.settings.agendaDebugging && Quest.Settings.settings.playMode === 'dev')
            Quest.IO.debugmsg(`AGENDA for ${npc.name}: ${s}; ${Quest.Utilities.formatList(arr, { doNotSort: true })}`);
    },
    debugS(s) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'agendaDebugging' does not exist on type ... Remove this comment to see the full error message
        if (Quest.Settings.settings.agendaDebugging && Quest.Settings.settings.playMode === 'dev')
            Quest.IO.debugmsg(`AGENDA comment: ${s}`);
    },
    disband(npc, arr) {
    ...
    findPath(start, end, maxlength) {
        if (start === end)
            return [];
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'pathID' does not exist on type '{ turnCo... Remove this comment to see the full error message
        if (!Quest.World.game.pathID)
            Quest.World.game.pathID = 0;
        ...
        while (currentList.length > 0 && length < maxlength) {
            ...
            for (const room of currentList) {
                ...
                for (const exit of exits) {
                    ...
                    // ts-error-fixed ts-migrate(2339) FIXME: Property 'pathID' does not exist on type '{ turnCo... Remove this comment to see the full error message
                    if (dest.pathfinderNote && dest.pathfinderNote.id === Quest.World.game.pathID)
                        continue;
                    // ts-error-fixed ts-migrate(2339) FIXME: Property 'pathID' does not exist on type '{ turnCo... Remove this comment to see the full error message
    ...
    handleWaitFor(npc, arr, immediate) {
    ...
    handleWaitUntilWhile(npc, arr, reverse, immediate) {
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
    ...
    jumpTo(npc, arr) {
        ...
        if (dest === 'player') {
            ...
            // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
            if (!Quest.World.w[dest])
                return Quest.IO.errormsg(`Location '${dest}' not recognised in the agenda of ${npc.name}`);
            // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
            if (!Quest.World.w[dest].room)
                dest = dest.loc; // go to the room the item is in
            // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
            if (!Quest.World.w[dest])
                return Quest.IO.errormsg(`Location '${dest}' not recognized in the agenda of ${npc.name}`);
        }
        npc.loc = dest;
        this.text(npc, arr);
        return true;
    ...
    leadTo(npc, arr) {
        ...
        if (npc.loc !== Quest.World.player.loc)
            return false;
    ...
    moveTo(npc, arr) {
        ...
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
        if (!exit)
            return Quest.IO.errormsg(`Could not find an exit to location '${dest}' in the agenda of ${npc.name}`);
    ...
    setItemAtt(npc, arr) {
        ...
        let value = arr.shift();
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (!Quest.World.w[item])
            Quest.IO.errormsg(`Item '${item}' not recognised in the agenda of ${npc.name}`);
        if (value === 'true')
            value = true;
        if (value === 'false')
            value = false;
    ...
    wait(npc, arr) {
        ...
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
        if (isNaN(arr[0]))
            Quest.IO.errormsg(`Expected wait to be given a number in the agenda of '${npc.name}'`);
    ...
    walkRandom(npc, arr) {
        ...
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
        if (!Quest.World.w[exit.name])
            Quest.IO.errormsg(`Location '${exit.name}' not recognised in the agenda of ${npc.name}`);
        npc.movingMsg(exit);
        npc.moveChar(exit);
        return false;
    },
    walkTo(npc, arr) {
        ...
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'findPath' does not exist on type '{ debu... Remove this comment to see the full error message
        const route = agenda.findPath(Quest.World.w[npc.loc], Quest.World.w[dest]);
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
        if (!route)
            Quest.IO.errormsg(`Location '${dest}' not reachable in the agenda of ${npc.name}`);
        // ts-error-fixed ts-migrate(7053) FIXME: Element implicitly has an 'any' type because expre... Remove this comment to see the full error message
...
const CONSULTABLE = function () {
    const res = {};
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'consultable' does not exist on type '{}'... Remove this comment to see the full error message
    res.consultable = true;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'askabout' does not exist on type '{}'.
    res.askabout = function (text1, text2) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'asktellabout' does not exist on type '{}... Remove this comment to see the full error message
        return this.asktellabout(text1, text2, Quest.lang.ask_about_intro, this.askOptions, 'ask');
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'tellabout' does not exist on type '{}'.
    res.tellabout = function (text1, text2) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'asktellabout' does not exist on type '{}... Remove this comment to see the full error message
        return this.asktellabout(text1, text2, Quest.lang.tell_about_intro, this.tellOptions, 'tell');
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'talkabout' does not exist on type '{}'.
    res.talkabout = function (text1, text2) {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'talkOptions' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    res.asktellabout = function (text1, text2, intro, list, action) {
        ...
        if (!Quest.World.player.testTalk(this))
            return false;
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'testTalk' does not exist on type '{}'.
        ...
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 2.
        if (Quest.Settings.settings.givePlayerAskTellMsg)
            Quest.IO.msg(intro(this, text1, text2), { char: Quest.World.player });
        const params = {
            action,
            char: this,
            text: text1,
        ...
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'askTellDone' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    res.askTellDone = function (params, response) {
        ...
        if (response.mentions) {
            for (const s of response.mentions) {
                if (!Quest.World.player.mentionedTopics.includes(s))
                    Quest.World.player.mentionedTopics.push(s);
            }
        }
        params.char.pause();
    };
...
export const QUESTION = function () {
    return {
        sayResponse(char, s) {
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'responses' does not exist on type '{ say... Remove this comment to see the full error message
...
export const TOPIC = function (fromStart) {
    return {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'loc' does not exist on type '{ conversat... Remove this comment to see the full error message
        belongsTo(loc) {
            return this.loc === loc;
        },
        conversationTopic: true,
        count: 0,
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'countdown' does not exist on type '{ con... Remove this comment to see the full error message
        eventIsActive() {
        ...
        runscript() {
            ...
            // ts-error-fixed ts-migrate(2554) FIXME: Expected 2 arguments, but got 1.
            if (obj === undefined)
                return Quest.IO.errormsg(`No conversing NPC called ${Quest.World.player.conversingWithNpc} found.`);
            obj.pause();
            this.hideTopic = this.hideAfter;
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'script' does not exist on type '{ conver... Remove this comment to see the full error message
            if (!this.script && !this.msg)
                return Quest.IO.errormsg(`Topic ${this.name} has neither script nor msg attributes.`);
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'script' does not exist on type '{ conver... Remove this comment to see the full error message
            if (this.script) {
                // ts-error-fixed ts-migrate(2339) FIXME: Property 'script' does not exist on type '{ conver... Remove this comment to see the full error message
                if (typeof this.script !== 'function')
                    return Quest.IO.errormsg(`script for topic ${this.name} is not a function.`);
                // ts-error-fixed ts-migrate(2339) FIXME: Property 'script' does not exist on type '{ conver... Remove this comment to see the full error message
                this.script.bind(obj)({ char: obj, player: Quest.World.player, topic: this });
            }
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'msg' does not exist on type '{ conversat... Remove this comment to see the full error message
            if (this.msg) {
                // ts-error-fixed ts-migrate(2339) FIXME: Property 'msg' does not exist on type '{ conversat... Remove this comment to see the full error message
                if (typeof this.msg !== 'string')
                    return Quest.IO.errormsg(`msg for topic ${this.name} is not a string.`);
                // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 2.
        ...
        showHideList(list, isShow) {
            if (typeof list === 'string') {
                // ts-error-fixed ts-migrate(2339) FIXME: Property 'name' does not exist on type '{ conversa... Remove this comment to see the full error message
