...
Quest.Settings.settings.output = function (report) {
...
Quest.Settings.settings.dateTime = {
    ...
    // ts-error-fixed ts-migrate(2322) FIXME: Type '{ startTime: number; data: { name: string; n... Remove this comment to see the full error message
