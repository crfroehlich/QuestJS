...
test.tests = function () {
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'suppressAntagonise' does not exist on ty... Remove this comment to see the full error message
    for (const skill of Quest.RPG.rpg.list)
        skill.suppressAntagonise = true;
    ...
    let l;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'orc' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual(false, l.includes(Quest.World.w.orc));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'goblin' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'resolve' does not exist on type 'boolean... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'snotling' does not exist on type '{}'.
    ...
    Quest.World.player.modifyOutgoingAttack = function (attack) {
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'flail' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'long_bow' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'ice_amulet' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'shotgun' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'title' does not exist on type '{}'.
    test.title('scrolls');
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'pink_scroll' does not exist on type '{}'... Remove this comment to see the full error message
    Quest.World.w.pink_scroll.loc = Quest.World.player.name;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'blue_scroll' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'title' does not exist on type '{}'.
    test.title('potions');
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'healing_potion' does not exist on type '... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'suppressAntagonise' does not exist on ty... Remove this comment to see the full error message
    for (const skill of Quest.RPG.rpg.list)
        delete skill.suppressAntagonise;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'goblin' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'tapestry' does not exist on type '{}'.
