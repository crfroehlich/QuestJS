...
Quest.Settings.settings.status = [
    // ts-error-fixed ts-migrate(2322) FIXME: Type 'string' is not assignable to type '() => str... Remove this comment to see the full error message
    'hitpoints',
    function () {
...
// ts-error-fixed ts-migrate(2339) FIXME: Property 'mapLabelStyle' does not exist on type '{... Remove this comment to see the full error message
