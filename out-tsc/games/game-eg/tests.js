...
test.tests = function () {
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'itemSetup' does not exist on type '{}'.
    ...
    let parserResult;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'findInScope' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    Quest.Parser.parser.pronouns = { him: Quest.World.w.Buddy, it: Quest.World.w.book };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'findInScope' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('Five bricks', Quest.lang.getName(Quest.World.w.brick, { article: Quest.Utilities.INDEFINITE, brick_count: 5, capital: true }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('a brick', Quest.lang.getName(Quest.World.w.brick, { article: Quest.Utilities.INDEFINITE, brick_count: 1 }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('seven bricks', Quest.lang.getName(Quest.World.w.brick, { article: Quest.Utilities.INDEFINITE, loc: 'lounge' }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('a lot of bricks', Quest.lang.getName(Quest.World.w.brick, { article: Quest.Utilities.INDEFINITE, brick_count: 'infinity' }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'title' does not exist on type '{}'.
    ...
    for (let i = 0; i < 3; i++) {
        ...
        if (ary2.includes(res))
            test.fail('ary2 already has that value');
        ary2.push(res);
    }
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'prime' does not exist on type '{ buffer:... Remove this comment to see the full error message
    ...
    test.assertEqual([
        ...
        'shoes',
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'combos' does not exist on type '{}'.
    ...
    Quest.World.player.tpTest1 = function (params) {
        return Quest.lang.toWords(2 * params.val);
    };
    Quest.World.player.tpTest2 = function (params) {
        return 2 * params.val;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'Lara' does not exist on type '{}'.
    Quest.World.player.tpTest3 = function (params) {
        return Quest.World.w.Lara;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'tpTest' does not exist on type '{ perfor... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    Quest.World.w.book.tpStringTest = function () {
        return 'testy';
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    Quest.World.w.book.tpStringTest = function (options) {
        return `testy=${options.obj.name}`;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    const testObject = { falseAtt: false, someOddAtt: true, someOtherAttribute: 5 };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('There are seven bricks.', Quest.Text.processText('There are {nm:item:count}.', { brick_count: 7, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'title' does not exist on type '{}'.
    test.title('Text processor 5a: nm with Quest.Templates.COUNTABLE.');
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('Five bricks', Quest.Text.processText('{nm:item:count:true}', { brick_count: 5, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('Five bricks', Quest.Text.processText('{nm:item:a:true}', { brick_count: 5, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('five bricks', Quest.Text.processText('{nm:item:a}', { item: Quest.World.w.brick, item_count: 5 }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('a brick', Quest.Text.processText('{nm:item:a}', { brick_count: 1, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('one brick', Quest.Text.processText('{nm:item:count}', { brick_count: 1, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('five bricks', Quest.Text.processText('{nm:item:a}', { count: 5, item: Quest.World.w.brick }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('five bricks and one book', Quest.Text.processText('{nm:item:a} and {nm:item2:count}', { count: 5, item: Quest.World.w.brick, item2: Quest.World.w.book }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    Quest.World.w.book.specialCount = 4;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('five bricks and four books', Quest.Text.processText('{nm:item:a} and {nm:item2:count:false:count_this}', {
        count: 5, count_this: 'specialCount', item: Quest.World.w.brick, item2: Quest.World.w.book,
    }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('Lara looks at the four books thoughtfully.', Quest.Text.processText('Lara looks at the {nm:item:false:false:count_this} thoughtfully.', { count_this: 'specialCount', item: Quest.World.w.book }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    Quest.World.w.book.specialCount = 1;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('Lara looks at the book thoughtfully.', Quest.Text.processText('Lara looks at the {nm:item:false:false:count_this} thoughtfully.', { count_this: 'specialCount', item: Quest.World.w.book }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'title' does not exist on type '{}'.
    test.title('Text processor 5b: nm with Quest.Templates.COUNTABLE too.');
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    Quest.World.w.book.getDisplayName = function (options) {
        return `a ${options.adj} tomb`;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual('You see a mighty tomb', Quest.Text.processText('You see {nm:item:a:false:adj}', { adj: 'mighty', item: Quest.World.w.book }));
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'Buddy' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'coin' does not exist on type '{}'.
    Quest.World.w.coin.loc = 'cardboard_box';
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'small_key' does not exist on type '{}'.
    Quest.World.w.small_key.loc = 'cardboard_box';
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'canteen' does not exist on type '{}'.
    ...
    test.assertOut(['Kyle is red.'], () => {
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 1.
        Quest.IO.msg('Kyle is {select:Kyle:colours:colour}.');
    });
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertOut' does not exist on type '{}'.
    test.assertOut(['Kyle is here.', 'Lara is not'], () => {
        // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 1.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'function' does not exist on type '{}'.
    res = test.function(() => {
        Quest.IO.msg('#Kyle is {select:Kyle:colours:colour}.', {}, 'test');
    });
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertOut' does not exist on type '{}'.
    test.assertOut(['watchedStringAttribute changed from yellow to red'], () => {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertOut' does not exist on type '{}'.
    test.assertOut(['watchedNumberAttribute changed from 9 to 11'], () => {
        // ts-error-fixed ts-migrate(2339) FIXME: Property 'book' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'setChangeListenersLoadString' does not e... Remove this comment to see the full error message
    ...
    let res2;
    ary2 = ['ham', 'cheese'];
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'oneFromTokens' does not exist on type '{... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'jewellery_box' does not exist on type '{... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'ham_and_cheese_sandwich' does not exist ... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 1.
    Quest.World.player.testTalk = function () {
        Quest.IO.msg('You are gagged.');
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertCmd' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2554) FIXME: Expected 3 arguments, but got 1.
    Quest.World.player.testManipulate = function () {
        Quest.IO.msg('You are handcuffed.');
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertCmd' does not exist on type '{}'.
    ...
    Quest.World.w.knife.use = function (options) {
        Quest.IO.msg('You juggle the knife.');
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertCmd' does not exist on type '{}'.
    ...
    test.assertError(/Trying to find topic/, () => {
        Quest.World.w.Lara.findTopic("What's the deal with the garden?");
    });
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'Lara' does not exist on type '{}'.
    Quest.World.w.Lara.testPosture = function () {
        Quest.IO.msg('She is turned to stone.');
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertCmd' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'far_away' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'cloneCounter' does not exist on type '{}... Remove this comment to see the full error message
    ...
    Quest.World.w.lift.afterTransitMove = function (toLoc, fromLoc) {
        Quest.IO.msg(`MOVING to ${toLoc} from ${fromLoc}`);
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertCmd' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'broken_chair' does not exist on type '{}... Remove this comment to see the full error message
    Quest.World.w.broken_chair.shift = function () {
        Quest.IO.msg('You try to push chair, but it just breaks even more.');
        return false;
    };
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'broken_chair' does not exist on type '{}... Remove this comment to see the full error message
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'assertEqual' does not exist on type '{}'... Remove this comment to see the full error message
    test.assertEqual(1, Quest.World.w.Buddy.money);
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'carrot0' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'Buddy' does not exist on type '{}'.
    Quest.World.w.Buddy.money = 20;
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'shop' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'timetable' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'carrot1' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'jug' does not exist on type '{}'.
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'honey_pot' does not exist on type '{}'.
    ...
    */
    ...
    // ts-error-fixed ts-migrate(2339) FIXME: Property 'check_lang' does not exist on type '{}'.
    if (this.check_lang) {
        const langSkips = [
            /regex/,
            /prefix/i,
        ...
        for (const el in lang) {
            if (typeof el !== 'string')
                continue;
            if (langSkips.find((e) => el.match(e)))
                continue;
            // ts-error-fixed ts-migrate(2339) FIXME: Property 'usedStrings' does not exist on type '{ t... Remove this comment to see the full error message
